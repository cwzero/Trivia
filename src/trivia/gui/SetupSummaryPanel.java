...
public class SetupSummaryPanel extends GamePanel {
	...
	protected void createGui() {
		...
		String playerLabel1 = "";
		// label says "Player1, player2, player3 want to play a game of x
		// rounds?"
		...
		buttonBack.setBounds(((gameFrame.getWidth() / 2) - 400), ((gameFrame.getHeight() / 2) + 65),
		...
		continueButton.setBounds((buttonBack.getX() + (buttonBack.getWidth())), buttonBack.getY(),
